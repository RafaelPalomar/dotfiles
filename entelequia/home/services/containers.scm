             ...
             (lambda (port)
               (display
                (string-append
                 ...
                 "  unset LIBRARY_PATH\n"
                 "  \n"
                 "  # Clear Guix compiler/build search paths, else the container's\n"
                 "  # gcc/g++/cmake/pkg-config pick up host Guix headers+libs (e.g. a\n"
                 "  # newer libstdc++ the container toolchain cannot parse)\n"
                 ...
                 "  unset GUIX_LOCPATH\n"
                 "  \n"
                 "  # Clear git helper paths that point at the host Guix git-core\n"
                 "  # (else the container's git dispatches to Guix git-remote-https,\n"
                 "  #  which looks for the Guix CA bundle and fails TLS verification)\n"
                 "  unset GIT_EXEC_PATH\n"
                 "  unset GIT_TEMPLATE_DIR\n"
                 "  \n"
                 "  # Clear TLS/CA bundle paths that point at the host Guix store\n"
                 "  # (they don't exist in the container; curl/git/pip die otherwise)\n"
                 "  unset SSL_CERT_FILE\n"
                 "  unset SSL_CERT_DIR\n"
                 ...
                 "  \n"
                 "  # Clear GTK/GDK-pixbuf paths that point at the host Guix store\n"
                 "  unset GTK_DATA_PREFIX\n"
                 "  unset GTK_PATH\n"
                 "  unset GDK_PIXBUF_MODULE_FILE\n"
                 "  unset GUIX_GDK_PIXBUF_MODULE_FILES\n"
                 "  \n"
